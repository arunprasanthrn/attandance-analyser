...
button2 = tk.Button(root, text='Create Document', width=25, command=root.destroy)
button2.pack()
button1.config(command=doc)
button3 = tk.Button(root, text='Attandance', width=25, command=root.destroy)
button3.pack()
button1.config(command=sorting)
root.mainloop()
